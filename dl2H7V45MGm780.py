...
db = mysql.connector.connect(
    host='localhost', user="root", passwd="window4237", database="xp", auth_plugin="mysql_native_password"
)
...
reddit = praw.Reddit(client_id = "qU9PjjuwItiWfQ", client_secret= "U11dfb2Q0FffxN95IJynRbtKalk_OA", username = "Fluffy-DEV", password = "eCQXULgvLgEh63t", user_agent = "lmaoiforgotthis", check_for_async=False)
...
bruh_moment = ["owner", "molecule", "you suck", "u suck", "stfu", "Aurora", "aurora"]
...
images3 = [
    'https://lumiere-a.akamaihd.net/v1/images/juggernaut-transport-vehicle-main_09946f42.jpeg?region=207%2C0%2C1073%2C538',
    'https://lumiere-a.akamaihd.net/v1/images/new-republic-prison-ship-main_c82a29ca.jpeg?region=229%2C0%2C951%2C536',
    'https://lumiere-a.akamaihd.net/v1/images/artillery-stormtrooper-main_b55b4bb9.jpeg?region=329%2C1%2C951%2C536',
    'https://lumiere-a.akamaihd.net/v1/images/peli-motto-main_54be3b15.jpeg?region=307%2C0%2C942%2C529',
    'https://lumiere-a.akamaihd.net/v1/images/millennium-falcon-main-tlj-a_7cf89d3a.jpeg?region=0%2C0%2C1280%2C720&width=960',
    'https://lumiere-a.akamaihd.net/v1/images/lava-meerkat-main_7cb1eac3.jpeg?region=0%2C0%2C1280%2C720&width=960',
    'https://lumiere-a.akamaihd.net/v1/images/corvus-main_4dcceb2e.jpeg?region=372%2C0%2C537%2C537&width=320',
    'https://lumiere-a.akamaihd.net/v1/images/bb-8-main_72775463.jpeg?region=187%2C40%2C882%2C496',
    'https://lumiere-a.akamaihd.net/v1/images/sorgan-main_a175bd85.jpeg?region=420%2C0%2C538%2C536&width=320',
    'https://lumiere-a.akamaihd.net/v1/images/mandalorian-databank_9914915c.jpeg?region=284%2C2%2C520%2C520&width=320',
    'https://lumiere-a.akamaihd.net/v1/images/Darth-Vader_6bda9114.jpeg?region=0%2C34%2C1400%2C699',
    'https://i.pinimg.com/originals/71/e0/e4/71e0e4b133bbdd4a76b01679de5d9ef8.jpg',
    'https://lumiere-a.akamaihd.net/v1/images/last-jedi-luke-quote-1_711c2443.jpeg?region=358%2C116%2C604%2C604',
]

ca = 'https://lumiere-a.akamaihd.net/v1/images/juggernaut-transport-vehicle-main_09946f42.jpeg?region=207%2C0%2C1073%2C538'
cb = 'https://lumiere-a.akamaihd.net/v1/images/new-republic-prison-ship-main_c82a29ca.jpeg?region=229%2C0%2C951%2C536'
cc = 'https://lumiere-a.akamaihd.net/v1/images/artillery-stormtrooper-main_b55b4bb9.jpeg?region=329%2C1%2C951%2C536'
cd = 'https://lumiere-a.akamaihd.net/v1/images/peli-motto-main_54be3b15.jpeg?region=307%2C0%2C942%2C529'
ce = 'https://lumiere-a.akamaihd.net/v1/images/millennium-falcon-main-tlj-a_7cf89d3a.jpeg?region=0%2C0%2C1280%2C720&width=960'
cf = 'https://lumiere-a.akamaihd.net/v1/images/lava-meerkat-main_7cb1eac3.jpeg?region=0%2C0%2C1280%2C720&width=960'
cg = 'https://lumiere-a.akamaihd.net/v1/images/corvus-main_4dcceb2e.jpeg?region=372%2C0%2C537%2C537&width=320'
ch = 'https://lumiere-a.akamaihd.net/v1/images/bb-8-main_72775463.jpeg?region=187%2C40%2C882%2C496'
ci = 'https://lumiere-a.akamaihd.net/v1/images/sorgan-main_a175bd85.jpeg?region=420%2C0%2C538%2C536&width=320'
cj = 'https://lumiere-a.akamaihd.net/v1/images/mandalorian-databank_9914915c.jpeg?region=284%2C2%2C520%2C520&width=320'
ck = 'https://lumiere-a.akamaihd.net/v1/images/Darth-Vader_6bda9114.jpeg?region=0%2C34%2C1400%2C699'
cl = 'https://i.pinimg.com/originals/71/e0/e4/71e0e4b133bbdd4a76b01679de5d9ef8.jpg'
cm = 'https://lumiere-a.akamaihd.net/v1/images/last-jedi-luke-quote-1_711c2443.jpeg?region=358%2C116%2C604%2C604'
...
async def eight_ball(ctx, *, message):
    msg = message
    if any(word in msg for word in bruh_moment):
...
async def guess(ctx):
    ...
    embed.add_field(name="<:pink:832279712151765002> Star Wars (.sw)", value="A character, artifact or vehicle", inline=False)
...
async def sw(ctx):
    global random_link3
    embed4 = discord.Embed(title="What's your Guess", color=0xededed)
    random_link3 = random.choice(images3)
    embed4.set_image(url=random_link3)
    embed4.set_footer(text="just type it down below | anyone can answer 👍")
    await ctx.channel.send(embed=embed4)

    if random_link3 == ca:
        channel = ctx.channel
        await channel.send('**Hint** vehicle')

        def check(m):
            return m.content.lower() == 'juggernaut transport vehicle' and m.channel == channel

        msg = await bot.wait_for('message', check=check)
        await channel.send(f' **GOOD JOB!** type ``.sw`` to play again'.format(msg))
    ...
    if random_link3 == cb:
        ...
        def check(m):
            return m.content.lower() == 'new republic prison ship' and m.channel == channel
    ...
    if random_link3 == cc:
        channel = ctx.channel
        await channel.send('**Hint** -NA-')

        def check(m):
            return m.content.lower() == 'artillery stormtrooper' and m.channel == channel
    ...
    if random_link3 == cd:
        ...
        def check(m):
            return m.content.lower() == 'peli motto' and m.channel == channel
    ...
    if random_link3 == ce:
        ...
        def check(m):
            return m.content.lower() == 'millennium falcon' and m.channel == channel
    ...
    if random_link3 == cf:
        channel = ctx.channel
        await channel.send('**Hint** animal')

        def check(m):
            return m.content.lower() == 'lava meerkat' and m.channel == channel
    ...
    if random_link3 == cg:
        channel = ctx.channel
        await channel.send('**Hint** planet')

        def check(m):
            return m.content.lower() == 'corvus' and m.channel == channel
    ...
    if random_link3 == ch:
        ...
        def check(m):
            return m.content.lower() == 'bb8' and m.channel == channel
    ...
    if random_link3 == ci:
        ...
        def check(m):
            return m.content.lower() == 'sorgan' and m.channel == channel
    ...
    if random_link3 == cj:
        ...
        def check(m):
            return m.content.lower() == 'the mandalorian' and m.channel == channel
    ...
    if random_link3 == ck:
        ...
        def check(m):
            return m.content.lower() == 'darth vader' and m.channel == channel
    ...
    if random_link3 == cl:
        ...
        def check(m):
            return m.content.lower() == 'kylo ren' and m.channel == channel
    ...
    if random_link3 == cm:
        ...
        def check(m):
            return m.content.lower() == 'luke skywalker' and m.channel == channel
...
bot.run("ODA0MjI4MDgwOTUyMDE2ODk3.YBJRxA.SeWg-uwrOUC3FnllrHQem3KI1yY")
